...
function loadPlayersPage() {
    ...
    for (var i = 0; i < players.length; i++) {
        selectorText += '<a class="dropdown-item" href="#" onclick="switchPlayers('+i+')">' + players[i].name;
    }
    document.getElementById('player_selector').innerHTML = selectorText;
}
...
function switchPlayers(playerNum) {
    ...
    var avgPY = players[playerNum].pass_yards / players[playerNum].games_played;
    var avgRuY = players[playerNum].rushing_yards / players[playerNum].games_played;
    var avgRecY = players[playerNum].receiving_yards / players[playerNum].games_played;

    document.getElementById('avg_p_yards').innerHTML = Number(Math.round(avgPY+'e2')+'e-2');
    document.getElementById('avg_r_yards').innerHTML = Number(Math.round(avgRuY+'e2')+'e-2');
    document.getElementById('avg_rec_yards').innerHTML = Number(Math.round(avgRecY+'e2')+'e-2');
}
